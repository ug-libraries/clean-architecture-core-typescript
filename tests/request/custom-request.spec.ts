...
import { BadRequestContentError } from "../../src/error/error";
import { Status } from "../../src/enum/status";
import { StatusCode } from "../../src/response/response";
import { z } from "zod";
...
describe("request class", () => {
  ...
  it("Should be able to build a custom new request and get as object", () => {
    ...
    expect(instanceRequest.toArray()).toStrictEqual({
      field_1: ["yes", "no"],
      field_2: 3,
      field_4: { field_5: ["nice"] },
    });
